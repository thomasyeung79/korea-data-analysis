...
OPTION_LABELS: dict[str, dict[str, dict[str, str]]] = {
    ...
    "education_level": {
        ...
        "Working Professional": {"en": "Working Professional", "zh": "在职人士"},
    ...
    "mbti_preference": {
        ...
        "Slow": {"en": "Slow", "zh": "慢节奏"},
        "Moderate": {"en": "Moderate", "zh": "中等节奏"},
        "Fast": {"en": "Fast", "zh": "快节奏"},
    },
    "korean_scenario": {
        "Classroom": {"en": "Classroom", "zh": "课堂"},
        "Professor": {"en": "Professor", "zh": "教授沟通"},
        "Library": {"en": "Library", "zh": "图书馆"},
        "Dormitory": {"en": "Dormitory", "zh": "宿舍"},
        "Campus": {"en": "Campus", "zh": "校园"},
        "Presentation": {"en": "Presentation", "zh": "课堂展示"},
        "Interview": {"en": "Interview", "zh": "面试"},
        "Resume": {"en": "Resume", "zh": "简历"},
        "Office": {"en": "Office", "zh": "办公室"},
        "Meeting": {"en": "Meeting", "zh": "会议"},
        "Email": {"en": "Email", "zh": "邮件"},
        "Business Phone": {"en": "Business Phone", "zh": "商务电话"},
        "Restaurant": {"en": "Restaurant", "zh": "餐厅"},
        "Convenience Store": {"en": "Convenience Store", "zh": "便利店"},
        "Hospital": {"en": "Hospital", "zh": "医院"},
        "Pharmacy": {"en": "Pharmacy", "zh": "药店"},
        "Bank": {"en": "Bank", "zh": "银行"},
...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "korean.page_title": {"en": "Korean Learning Support", "zh": "韩语场景支持"},
    "korean.tab_study": {"en": "Study Korean", "zh": "留学韩语"},
    "korean.tab_career": {"en": "Career Korean", "zh": "职场韩语"},
    "korean.tab_living": {"en": "Living Korean", "zh": "生活韩语"},
    "korean.tab_topik": {"en": "TOPIK Planner", "zh": "TOPIK 规划"},
    "korean.scenario": {"en": "Scenario", "zh": "场景"},
    "korean.topik_level": {"en": "TOPIK Level", "zh": "TOPIK 等级"},
    "korean.useful_expressions": {"en": "Useful Expressions", "zh": "实用表达"},
    "korean.dialogue": {"en": "Dialogue", "zh": "示例对话"},
    "korean.conversation": {"en": "Conversation", "zh": "示例会话"},
    "korean.vocabulary": {"en": "Vocabulary", "zh": "词汇"},
    "korean.ai_explanation": {"en": "AI Explanation", "zh": "AI 解释"},
    "korean.tips": {"en": "Tips", "zh": "提示"},
    "korean.common_questions": {"en": "Common Questions", "zh": "常见问题"},
    "korean.culture_tips": {"en": "Culture Tips", "zh": "文化提示"},
    "korean.current_level": {"en": "Current Level", "zh": "当前水平"},
    "korean.target_level": {"en": "Target Level", "zh": "目标等级"},
    "korean.study_hours": {"en": "Recommended Study Hours", "zh": "建议学习时长"},
    "korean.weekly_plan": {"en": "Weekly Study Plan", "zh": "每周学习计划"},
    "korean.resources": {"en": "Suggested Resources", "zh": "推荐资源"},
    "korean.roadmap": {"en": "Learning Roadmap", "zh": "学习路线"},
