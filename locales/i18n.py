...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "home.kpi.job": {"en": "Job Market Analyzer", "zh": "就业市场分析器"},
    ...
    "home.regional_context": {"en": "REGIONAL CONTEXT", "zh": "区域背景"},
    "home.context_heading": {"en": "Korea in its East Asian context", "zh": "东亚背景下的韩国"},
    "home.context_caption": {
        "en": "Six economies and six shared dimensions provide the benchmark behind the product.",
        "zh": "六个经济体与六个共同维度构成产品背后的基准。",
    },
    "home.country_points": {"en": "{count} data points · 6 categories", "zh": "{count} 个数据点 · 6 个维度"},
    ...
    "home.flow.job.title": {"en": "Analyze Job Market", "zh": "分析就业市场"},
    "home.flow.job.desc": {"en": "See salary ranges, required skills, and visa pathways for tech roles.", "zh": "查看技术岗位的薪资范围、技能要求和签证路径。"},
    ...
    "home.job.desc": {"en": "Analyze Korean tech job requirements, salary ranges, and visa pathways.", "zh": "分析韩国科技岗位要求、薪资范围和签证路径。"},
    ...
    "home.legacy_label": {"en": "LEGACY MODULES", "zh": "旧版模块"},
    "home.legacy_heading": {"en": "V1 features (still active)", "zh": "V1 功能（仍可使用）"},
    ...
    "job.page_title": {"en": "IT Job Market Analyzer", "zh": "IT 就业市场分析器"},
    "job.brand": {"en": "V2 · MODULE 2", "zh": "V2 · 模块 2"},
    "job.heading": {"en": "Korea IT Job Market Analyzer", "zh": "韩国 IT 就业市场分析器"},
    "job.subtitle": {
        "en": "Analyse salary ranges, skill requirements, and visa pathways for tech roles in Korea. Get a personalised 3-month preparation plan based on your profile.",
        "zh": "分析韩国技术岗位的薪资范围、技能要求和签证路径，并根据你的背景生成个性化 3 个月准备计划。",
    },
    ...
    "job.footer": {"en": "Korea Study & Career Decision Agent · IT Job Market Analyzer v1.0", "zh": "韩国学习与职业决策助手 · IT 就业市场分析器 v1.0"},
