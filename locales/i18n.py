...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "home.page_title": {"en": "Korea Analysis", "zh": "韩国分析"},
    "home.brand": {"en": "KOREA STUDY & CAREER DECISION AGENT", "zh": "韩国学习与职业决策助手"},
    ...
    "home.kpi.report": {"en": "AI Decision Report", "zh": "AI 决策报告"},
    ...
    "home.flow.report.title": {"en": "Generate Decision Report", "zh": "生成决策报告"},
    ...
    "study.footer": {"en": "Korea Study & Career Decision Agent · Study Cost Calculator v1.0", "zh": "韩国学习与职业决策助手 · 留学成本计算器 v1.0"},
    ...
    "job.footer": {"en": "Korea Study & Career Decision Agent · Career & Job Market Analyzer v1.0", "zh": "韩国学习与职业决策助手 · 职业与就业市场分析 v1.0"},

    "decision.page_title": {"en": "AI Decision Report", "zh": "AI 决策报告"},
    "decision.brand": {"en": "V2 · MODULE 3", "zh": "V2 · 模块 3"},
    "decision.heading": {"en": "AI Decision Report", "zh": "AI 决策报告"},
    ...
    "decision.generate": {"en": "Generate Decision Report", "zh": "生成决策报告"},
    ...
    "decision.empty": {"en": "Fill in your profile above and click **Generate Decision Report** to see your personalised report.", "zh": "填写上方资料并点击 **生成决策报告** 查看你的个性化报告。"},
    "decision.footer": {"en": "Korea Study & Career Decision Agent · AI Decision Report v1.0", "zh": "韩国学习与职业决策助手 · AI 决策报告 v1.0"},
    ...
    "news.footer": {"en": "Korea Study & Career Decision Agent · News & Policy v1.0 (mock data)", "zh": "韩国学习与职业决策助手 · 新闻与政策 v1.0（模拟数据）"},
