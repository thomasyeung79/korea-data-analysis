...
def study_scenarios():
    return korean_learning.get_study_scenarios()


@router.get("/career", response_model=list[CareerScenario])
def career_scenarios():
    return korean_learning.get_career_scenarios()


@router.get("/living", response_model=list[LivingScenario])
def living_scenarios():
    return korean_learning.get_living_scenarios()
