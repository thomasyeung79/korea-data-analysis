...
st.title(tr("🧠 Korean Society & Daily Life", "🧠 韩国社会与日常生活"))
...
st.caption(
    tr("Understanding Korean society beyond stereotypes about pressure, competition, and daily life.", "跳出关于压力、竞争和日常生活的刻板印象来理解韩国社会。")
)

st.divider()

st.subheader(tr("⚖️ Society Perception vs Reality", "⚖️ 社会认知与现实"))
...
st.subheader(tr("🏙️ Work & Life System", "🏙️ 工作与生活系统"))
...
st.subheader(tr("📊 Society Balance Simulator", "📊 社会平衡模拟器"))
...
if api.is_authenticated:
    try:
        api.save_module_score("Society", society_score)
    except Exception:
        pass
