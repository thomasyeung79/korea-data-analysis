...
st.title(tr("🏅 Sports Visibility Intelligence", "🏅 体育可见度智能分析"))
...
st.caption(
    tr("Track athletes, football pathways, and multi-sport strengths as signals of visibility and national image.", "把运动员、足球路径与多项目实力作为国家可见度和形象信号。")
)
...
st.subheader(tr("🧠 Sports Perception Check", "🧠 体育认知检查"))
...
st.subheader(tr("🏅 Multi-Sport Strength", "🏅 多项目体育实力"))
...
st.subheader(tr("⚽ Korean Football", "⚽ 韩国足球"))
...
st.subheader(tr("🌏 East Asia Sports Comparison", "🌏 东亚体育对比"))
...
st.subheader(tr("🧠 Comparison Insight Engine", "🧠 对比洞察引擎"))
...
st.subheader(tr("⚖️ Who Leads in What?", "⚖️ 谁在哪些方面领先？"))
...
st.subheader(tr("📊 Sports Power Simulator", "📊 体育实力模拟器"))
...
if api.is_authenticated:
    try:
        api.save_module_score("Sports", sports_score)
    except Exception:
        pass

st.divider()

st.subheader(tr("🧠 Final Insight", "🧠 最终洞察"))
